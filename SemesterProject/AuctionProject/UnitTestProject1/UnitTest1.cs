...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public Product CreateTestProduct()
        {
            ...
            return new Product { Name = "productname", Description = "descriptionofproduct", Picture = "dasda", Price = 200,Stock=10, CategoryId = category.Id, Category = category };
        }

        Account CreateTestAccount()
        {
            return new Account { Fname = "fname", Lname = "lname", Password = "password", Address = "address", Email = "email.com", PhoneNumber = "12345", UserName = "usernamee" };
        }
